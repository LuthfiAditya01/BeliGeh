...
<div class="flex items-center justify-center h-full">
    <div class="w-full max-w-6xl p-6 bg-white shadow-md rounded-lg">
     <div class="flex flex-col">
      <div class="w-full">
       <img alt="Poster of the event showing a vibrant and colorful design with event details" class="rounded-lg shadow-md w-full" src="{{ asset('assets/img/JKT48_13th_Concert.jpg') }}"/>
      </div>
      <div class="mt-6">
